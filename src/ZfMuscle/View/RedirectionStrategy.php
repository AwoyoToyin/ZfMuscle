...
use ZfMuscle\Event\Guard\Application as AppGuard;
...
class RedirectionStrategy implements ListenerAggregateInterface
{
    ...
    {
        $this->listeners[] = $events->attach(MvcEvent::EVENT_DISPATCH_ERROR, array($this, 'onDispatchError'), -5001);
    }
